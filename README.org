...
***   Version ~0.4.0~ broke the user API, see [[https://www.twistfold.it/nodgui.html#orgb574adf][here]] for more information about how your code is affected and how to fix it.
...
* Documentation
   please follow
   [[https://www.twistfold.it/nodgui.html][this link for documentation and news]].
