...
* Widget pack
  This library define a few additional widgets more than standard the TK ones.

  There should be  a decent quantity  of documentation as docstrings  on the
  sources.

  Probably checking
  [[http://quickdocs.org/nodgui/][the excellent quickdocs]]
  or
  [[https://quickref.common-lisp.net/nodgui.html][the excellent as well quickref]]
...
** TKlib
   ...
   Some  more widget  in ~nodgui~  derive from  wrapping and,  in some
   case,     extending     the     widget     set     contained     in
   [[https://core.tcl-lang.org/tklib/home][TKlib]]
...
*** TKlib derived widgets
    ...
    - calendar      :: A widget to choose a date;
    - notify-window :: show a fading out notification text to the user;
                       on the top right of the screen;
    - dot-plot      :: draw a scatter plot (with optional error bars) on a canvas.
...
* FAQ
  ...
  - What are the differences between nodgui and LTK? ::
    ...
    2. A DSL  for  TCL code  that  allow  to mix  TCL  code and  lisp
       ...
       is an annoying bug that will be solved soon or later.
