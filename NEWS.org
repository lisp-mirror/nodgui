...
This version fixes a bug in combobox widget.

When setting values of the combobox strings that contained spaces was splitted in multiple values.
...
resulted in a combo with 3 values ("foo" "and" "bar"), instead of a single value: "foo and bar".
...
This version fixes a bugs that prevented nodgui-lite to works.
Thanks to vindarel, for reporting this issue!

* 2025-12-20 0.7.6.2

This version fixes a bugs that prevented to add a space using a virtual keyboard. Also the behaviour of the backspace key was improved.

* 2025-12-03 0.7.6.1

This version improve usability of the virtual keyboard.

* 2025-11-02 0.7.6.0
- [new-feature]
  - added "option-clear" and "option-add" to manipulate database of widgets options.
