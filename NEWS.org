...
- [improvements]
  ...
  - prevented closing  the pipe  to wish when  an reading  error occurs, this way users can wrap their code with 'handler-case' or similar tomanage the error signaled;
